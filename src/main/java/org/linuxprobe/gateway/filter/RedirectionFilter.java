                ...
                if (this.getStatusCode().is3xxRedirection()) {
                    ...
                    if (requestRoute.getUri().toString().toLowerCase().startsWith("lb://")) {
                        ...
                        if (requestUrl.getAuthority().equals(responseLocation.getAuthority())) {
                            ...
                            String gateWayDomain = request.getHeaders().get("Host").get(0);
                            String scheme = request.getURI().getScheme();
                            StringBuilder responseUrl = new StringBuilder(scheme);
                            responseUrl.append("://");
                            responseUrl.append(gateWayDomain);
                            responseUrl.append(xForwardedPrefix);
